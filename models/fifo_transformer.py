...
from diffusers.models.embeddings import PixArtAlphaTextProjection, get_1d_sincos_pos_embed_from_grid
...
class FIFOTransformer3DModel(ModelMixin, ConfigMixin):
