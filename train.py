...
from models.fifo_transformer import FIFOTransformer3DModel
...
def parse_args():
    ...
    parser.add_argument(
        "--video_column", type=str, default="image", help="The column of the dataset containing an image."
    )
    parser.add_argument(
        "--caption_column",
        type=str,
...
def main(args):
    ...
    transformers = FIFOTransformer3DModel(
    ...
    if args.enable_xformers_memory_efficient_attention:
        if is_xformers_available():
            ...
            transformers.enable_xformers_memory_efficient_attention()
        else:
